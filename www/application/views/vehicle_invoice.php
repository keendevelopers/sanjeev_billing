...
<div class="form-group">
<label for="surcharge_per" class="col-sm-4 control-label">Surcharge (%)*</label>
<div class="col-sm-7">
<select for="surcharge_per" class="col-sm-12 form-control kd_select" id="surcharge_per" name="surcharge_per" onchange="get_total_amount();" required>
        ...
        <option value="Surcharge-10">Surcharge 10%</option>
...
<label for="inputEmail3" class="col-sm-4 control-label">Sur. Amount (<i class="fa fa-inr" aria-hidden="true"></i>)*</label>
<div class="col-sm-7">
<input type="text" id="surcharge_amt" name="surcharge_amt"  class="form-control" placeholder="Surcharge Amount" readonly="" value="<?php echo isset($edit['surcharge_amt'])? $edit['surcharge_amt']:'';?>">
</div>
</div>
...
$('#surcharge_amt_div').slideDown();
  ...
  var sur_amount = (parseFloat(tax_amount)*sur_per)/100;
