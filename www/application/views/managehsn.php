  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" id="offer_add_form">
...
submitHandler: function(e){
	$.post('<?php echo base_url("welcome/managehsn");?>',$('#offer_add_form').serialize(),function(data){
		if(data.result == 'success'){
		 ...
		 $.toaster({ priority : data.result, title : data.title, message : data.message});
			...
			$.toaster({ priority : 'danger', title : 'Error', message : 'Unable to process your request.'});
		}
	},'json');
