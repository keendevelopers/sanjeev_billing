...
class Product_list extends CI_Model {
    var $table = 'buyed_product_bill';
    var $column_order = array(null,'BillNo','BillBy','SubTotal','Tax_1','Total','PurchasedOn'); //set column field database for datatable orderable
    var $column_search = array('BillNo','BillBy','SubTotal','Tax_1','Total','PurchasedOn'); //set column field database for datatable searchable
    var $order = array('BillId' => 'desc'); // default order
