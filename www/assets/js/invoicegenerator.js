...
function createCookie(e, n) {
    ...
    if (!o && t) {
        ...
        var c = "; expires=" + s.toGMTString() + "; domain=.zoho.com; path=/";
...
function showUserInfo() {
    ...
    n ? (n = decodeHexString(window.zohouser.DISPLAY_NAME), $(".signin").css("display", "none"), $(".signup").css("display", "none"), $("#pricing-try-section").css("display", "none"), $(".z-signup").css("visibility", "hidden"), $("#z-access").html("<div class='z-access'><h3>Looks like you're already logged in!</h3><div><a class='btn-prim' href='https://invoice." + e + "/home'>Access Zoho Invoice</a></div></div>")) : ($(".z-signup").css("visibility", "visible"), $("#companyName").focus())
}
...
CreateInvoiceUtil.TOTAL_LINE_ITEMS = $('.lineItems tr').length-1, CreateInvoiceUtil.addInvoiceLineItem = function() {
    var r = CreateInvoiceUtil.TOTAL_LINE_ITEMS + 1,
        e = "lineItem." + r,
        n = $(".trClone").clone();
    n.attr("id", e).removeClass("trClone hide").addClass("row-item"), CreateInvoiceUtil.assignIdToChildElements(n, r), n.appendTo(".lineItems"), CreateInvoiceUtil.updateTabIndexForLabels(r), CreateInvoiceUtil.TOTAL_LINE_ITEMS = r
    ...
    c > 1 && ($("#lineItem\\." + n).remove(), c--), CreateInvoiceUtil.calculateInvoiceTotal()
}, CreateInvoiceUtil.assignIdToChildElements = function(r, e) {
    for (var n = $(r).children(), c = n.length, a = Number($("#itemRate\\." + (e - 1)).attr("tabindex")) + 1, y = 0; y < c; y++) {
        ...
        if ("INPUT" === u || "SPAN" === u || "TEXTAREA" === u || "A" === u) {
            ...
            var m = $(n[y]).attr("id").lastIndexOf("."),
                ...
                o = l + "." + e;
            $(n[y]).attr("id", o), $(n[y]).attr("name", o), "TEXTAREA" === u && (autosize($(n[y])), $(n[y]).addClass("lastLineItem")), void 0 !== $(n[y]).attr("tabindex") && $(n[y]).attr("tabindex", a)
        }
    }
}, CreateInvoiceUtil.updateTabIndexForLabels = function(r) {
    for (var e = $("#itemRate\\." + r).attr("tabindex") + 1, n = ["subTotalLabel", "taxLabel", "totalLabel", "currencyCode", "notesLabel", "customerNotes", "termsLabel", "terms"], c = 0; c <= 7; c++) $("#" + n[c]).attr("tabindex", e), e++
    ...
    c = (a * y).toFixed("2"), $("#itemTotal\\." + n).val(c), CreateInvoiceUtil.calculateInvoiceTotal()
}, CreateInvoiceUtil.calculateInvoiceTotal = function() {
    for (var r = Number(0), e = "0.00", n = "", c = 1; c <= CreateInvoiceUtil.TOTAL_LINE_ITEMS; c++) n = $("#itemTotal\\." + c), null === n || isNaN(n.val()) || (e = Number(n.val()), r += e);
    r = r.toFixed("2"), $("#subTotal").html(r), CreateInvoiceUtil.calculateInvTaxAndTotal()
}, CreateInvoiceUtil.hideHelpText = function() {}, CreateInvoiceUtil.checkAndAddNewLineItem = function(r, e) {
    if (9 !== e.keyCode && $(r).hasClass("lastLineItem") && 0 === $(r).val().length) {
        ...
        CreateInvoiceUtil.addInvoiceLineItem(), $(r).removeClass("lastLineItem"), $("#itemDesc\\." + c).addClass("lastLineItem")
    }
...
var InvoiceGenerator = {
    ...
    validateForm: function(r) {
        var e = !0;
        return r.company_name || (this.showHideErr("address1", !0), e = !1), r.customer_name || (this.showHideErr("billingAddress1", !0), e = !1), e
    },
    getInvoicePDF: function(r, e) {
        ...
        y.setAttribute("method", "POST"), y.setAttribute("action", a), y.setAttribute("target", "_blank");
        var u = document.createElement("input");
        u.setAttribute("name", "JSONString"), u.setAttribute("value", c), y.appendChild(u), document.body.appendChild(y), y.submit(), document.body.removeChild(y)
    },
        ...
        for (var _ in n) {
            ...
            if (b)
                if (b.isArray) {
                    ...
                    Number(y - 1) !== Number(a) && (a = y - 1, l += 1, o = {}), i !== u && (i = "", l = 0, s = []), o = this.includeInJSON(o, b.jsonNode, n[_].value), s[l] = o, c[u] = s
    ...
    includeInJSON: function(r, e, n) {
        return "undefined" !== n && "null" !== n && e && (r[e] = n), r
    },
    showCurrencySelect: function(r, e) {
        var n = $("#" + r),
            c = $("#" + e);
        n.addClass("hide"), c.removeClass("hide"), $("#currencyCode").attr("value", $("#currencySelect").val()), $("#currencySym").attr("value", $("#currencySelect option:selected").attr("symbol"))
    },
    currencyList: {
        AED: {
